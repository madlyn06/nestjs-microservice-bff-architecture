...
export class KeycloakHttpService {
    ...
    constructor(private readonly configService: ConfigService) {
        // Initialize Keycloak configuration and Axios instance here
        this.axiosInstance = axios.create({ baseURL: this.configService.get('KEYCLOAK_HOST') || 'http://localhost:8180' });
